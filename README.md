...
ex)<br>
깃 API : 기존의 CLI위주의 형상관리시스템을 학생들에게 클릭이나 드래그 앤 드롭으로 쉽게 관리할 수 있도록 기능 제공<br>
AI 자기소개서 : 문서 작성이나 아직 자기소개서등을 작성해보지 않은 학생들에게 자신의 장점이나 알리고 싶은 부분을 몇가지 문항으로 제시하여 하나의 임시 자기소개서를 AI를 통해 제공하는 기능<br>
